...
const MyAllPhotos = (props: any) => {
    const photos = (photo: any) => {
        let myArr: any = [];
        console.log(photo[0]);
        if (photo || photo[0].length == 0) {
            myArr.push(
                <div className="acc-setting">
                    <div className="notifications-list">
                        <div className="notfication-details">Empty Photo</div>
                    </div>
                </div>
            );
        } else {
                ...
                myArr.push(
                    <div className="col-lg-4 col-md-4 col-sm-6" key={i}>
                        <div className="company_profile_info">
                            <div
                                className="company-up-info"
                                style={{ padding: "0px" }}
                            >
                                <img
                                    src={photo[0][i].imageUrl}
                                    alt=""
                                    style={{
                                        float: "none",
                                        marginBottom: "6px",
                ...
                <div className="acc-setting">
                    <div className="acc-setting">
                        ...
                        <div className="companies-list">
                            <div className="row">{photos(props.photo)}</div>
                        </div>
                    </div>
                </div>
            </ProfileProps>
